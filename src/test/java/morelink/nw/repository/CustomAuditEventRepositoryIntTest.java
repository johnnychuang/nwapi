package morelink.nw.repository;

import morelink.nw.NewworldApp;
import morelink.nw.config.Constants;
import morelink.nw.config.audit.AuditEventConverter;
import morelink.nw.domain.PersistentAuditEvent;
...
import static morelink.nw.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
